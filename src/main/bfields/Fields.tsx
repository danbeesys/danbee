...
const Fields: React.FC = () => {
    return (
      <section id="fields" className='fields-body'>
            ...
            <h2>심리검사</h2>
            <p>- 성격검사 10 (HTP + SCT + ) 50 . 만 해석상담 분</p>
            <p>- 정서 및 정신건강 검사 20 (MMPI-2 MMPI-A + TCI + ) 80 만 또는 해석상담 분</p>
            <p>- 기질 및 성격검사 10 (TCI + SCT + ) 50 만 해석상담 분</p>
            <p>- 대인관계 검사 12 (TAT + HTP + ) 60 만 해석상담 분</p>
            <p>- 나를 이해하는 검사 20 (MMPI-2 + TCI + SCT + ) 80 만 해석상담 분</p>
    </section>
)
};
